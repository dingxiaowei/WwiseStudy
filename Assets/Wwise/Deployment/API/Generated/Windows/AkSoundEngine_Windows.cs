...
public partial class AkSoundEngine
{
    ...
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_SOUNDBANK_VERSION_get(); }
    }

    public static ushort AK_INT
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_INT_get(); }
    }

    public static ushort AK_FLOAT
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_FLOAT_get(); }
    }

    public static byte AK_INTERLEAVED
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_INTERLEAVED_get(); }
    }

    public static byte AK_NONINTERLEAVED
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_NONINTERLEAVED_get(); }
    }
    ...
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_LE_NATIVE_SAMPLETYPE_get(); }
    }

    public static uint AK_LE_NATIVE_INTERLEAVE
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_LE_NATIVE_INTERLEAVE_get(); }
    }
    ...
    /// 播放音效
    /// </summary>
    /// <param name="in_pszEventName">事件名称</param>
    /// <param name="in_gameObjectID">事件ID</param>
    /// <returns></returns>
    ...
    public static AKRESULT PrepareEvent(AkPreparationType in_PreparationType, string[] in_ppszString, uint in_uNumEvent)
    {
        ...
        try { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_0((int)in_PreparationType, pMem, in_uNumEvent); }
        finally
        {
    ...
    public static AKRESULT PrepareEvent(AkPreparationType in_PreparationType, string[] in_ppszString, uint in_uNumEvent, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
    {
        ...
        in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
        try { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_2((int)in_PreparationType, pMem, in_uNumEvent, global::System.IntPtr.Zero, in_pCookie != null ? (global::System.IntPtr)in_pCookie.GetHashCode() : global::System.IntPtr.Zero); }
        finally
        {
            global::System.Runtime.InteropServices.Marshal.FreeHGlobal(pMem);
        }
    ...
    public static AKRESULT PrepareGameSyncs(AkPreparationType in_PreparationType, AkGroupType in_eGameSyncType, string in_pszGroupName, string[] in_ppszGameSyncName, uint in_uNumGameSyncs)
    {
        ...
        try { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_0((int)in_PreparationType, (int)in_eGameSyncType, in_pszGroupName, pMem, in_uNumGameSyncs); }
        finally
        {
            global::System.Runtime.InteropServices.Marshal.FreeHGlobal(pMem);
        }
    ...
    public static AKRESULT PrepareGameSyncs(AkPreparationType in_PreparationType, AkGroupType in_eGameSyncType, string in_pszGroupName, string[] in_ppszGameSyncName, uint in_uNumGameSyncs, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
    {
        ...
        in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
        try { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_2((int)in_PreparationType, (int)in_eGameSyncType, in_pszGroupName, pMem, in_uNumGameSyncs, global::System.IntPtr.Zero, in_pCookie != null ? (global::System.IntPtr)in_pCookie.GetHashCode() : global::System.IntPtr.Zero); }
        finally
        {
            global::System.Runtime.InteropServices.Marshal.FreeHGlobal(pMem);
        }
    ...
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_INVALID_MIDI_CHANNEL_get(); }
    }

    public static byte AK_INVALID_MIDI_NOTE
    {
        get { return AkSoundEnginePINVOKE.CSharp_AK_INVALID_MIDI_NOTE_get(); }
    }
    ...
    {
        get { return AkSoundEnginePINVOKE.CSharp_kDefaultMaxPathLength_get(); }
    }

    public static uint kDefaultDiffractionMaxEdges
    {
        get { return AkSoundEnginePINVOKE.CSharp_kDefaultDiffractionMaxEdges_get(); }
    }

    public static uint kDefaultDiffractionMaxPaths
    {
        get { return AkSoundEnginePINVOKE.CSharp_kDefaultDiffractionMaxPaths_get(); }
    }

    public static float kMaxDiffraction
    {
        get { return AkSoundEnginePINVOKE.CSharp_kMaxDiffraction_get(); }
    }

    public static uint kListenerDiffractionMaxEdges
    {
        get { return AkSoundEnginePINVOKE.CSharp_kListenerDiffractionMaxEdges_get(); }
    }

    public static uint kListenerDiffractionMaxPaths
    {
        get { return AkSoundEnginePINVOKE.CSharp_kListenerDiffractionMaxPaths_get(); }
    }

    public static uint kPortalToPortalDiffractionMaxPaths
    {
        get { return AkSoundEnginePINVOKE.CSharp_kPortalToPortalDiffractionMaxPaths_get(); }
    }

    public static int g_SpatialAudioPoolId
    {
        set { AkSoundEnginePINVOKE.CSharp_g_SpatialAudioPoolId_set(value); }
        get { return AkSoundEnginePINVOKE.CSharp_g_SpatialAudioPoolId_get(); }
    }
